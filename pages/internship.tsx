                            ...
                            >
                                <AccordionItem>
                                    ...
                                    >
                                        ...
                                        >
                                            {t(
                                                'internship.Recruitment Plan.title'
                                            )}{' '}
                                            🗓
                                        </Text>
                                    ...
                                    <AccordionPanel pb={4}>
                                        ...
                                        >
                                            {t(
                                                'internship.Recruitment Plan.content'
                                            )}
                                        </Text>
                                    </AccordionPanel>
                                </AccordionItem>
                                <AccordionItem>
                                    ...
                                    >
                                        <Text fontSize='md'>
                                            {t(
                                                'internship.Company Profile.title'
                                            )}{' '}
                                            🏢
                                        </Text>
                                        <ChevronDownIcon fontSize='24px' />
                                    ...
                                    <AccordionPanel pb={4}>
                                        ...
                                        >
                                            {t(
                                                'internship.Company Profile.content'
                                            )}
                                            <br />
                                            <br />
                                            <Link
                                ...
                                <AccordionItem>
                                    ...
                                    >
                                        <Text fontSize='md'>
                                            {t(
                                                'internship.Internship Content.title'
                                            )}{' '}
                                            💼
                                        </Text>
                                        <ChevronDownIcon fontSize='24px' />
                                    ...
                                    <AccordionPanel pb={4}>
                                        ...
                                        >
                                            <UnorderedList>
                                                <ListItem>
                                                    {t(
                                                        'internship.Internship Content.list.0'
                                                    )}
                                                </ListItem>
                                                <ListItem>
                                                    {t(
                                                        'internship.Internship Content.list.1'
                                                    )}
                                                </ListItem>
                                                <ListItem>
                                                    {t(
                                                        'internship.Internship Content.list.2'
                                                    )}
                                                </ListItem>
                                                <ListItem>
                                                    {t(
                                                        'internship.Internship Content.list.3'
                                                    )}
                                                </ListItem>
                                                <ListItem>
                                                    {t(
                                                        'internship.Internship Content.list.4'
                                                    )}
                                                </ListItem>
                                            </UnorderedList>
                                        </Text>
                                ...
                                <AccordionItem>
                                    ...
                                    <AccordionPanel pb={4}>
                                        ...
                                        >
                                            {t(
                                                'internship.Internship Benefit.content'
                                            )}
                                            <UnorderedList>
                                                <ListItem>
                                                    {t(
                                                        'internship.Internship Benefit.list.0'
                                                    )}
                                                </ListItem>
                                                <ListItem>
                                                    {t(
                                                        'internship.Internship Benefit.list.1'
                                                    )}
                                                </ListItem>
                                                <ListItem>
                                                    {t(
                                                        'internship.Internship Benefit.list.2'
                                                    )}
                                                </ListItem>
                                                <ListItem>
                                                    {t(
                                                        'internship.Internship Benefit.list.3'
                                                    )}
                                                </ListItem>
                                                <ListItem>
                                                    {t(
                                                        'internship.Internship Benefit.list.4'
                                                    )}
                                                </ListItem>
                                                <ListItem>
                                                    {t(
                                                        'internship.Internship Benefit.list.5'
                                                    )}
                                                </ListItem>
                                            </UnorderedList>
                                        </Text>
                                ...
                                <AccordionItem>
                                    ...
                                    >
                                        <Text fontSize='md'>
                                            {t(
                                                'internship.About The Internship.title'
                                            )}{' '}
                                            📋
                                        </Text>
                                        <ChevronDownIcon fontSize='24px' />
                                    ...
                                    <AccordionPanel pb={4}>
                                        ...
                                        >
                                            <UnorderedList>
                                                <ListItem>
                                                    {t(
                                                        'internship.About The Internship.list.0'
                                                    )}
                                                </ListItem>
                                                <ListItem>
                                                    {t(
                                                        'internship.About The Internship.list.1'
                                                    )}
                                                </ListItem>
                                                <ListItem>
                                                    {t(
                                                        'internship.About The Internship.list.2'
                                                    )}
                                                </ListItem>
                                                <ListItem>
                                                    {t(
                                                        'internship.About The Internship.list.3'
                                                    )}
                                                </ListItem>
                                            </UnorderedList>
                                        </Text>
                                ...
                                <AccordionItem>
                                    ...
                                    >
                                        <Text fontSize='md'>
                                            {t(
                                                'internship.Required Skills.title'
                                            )}{' '}
                                            🔑
                                        </Text>
                                        <ChevronDownIcon fontSize='24px' />
                                    ...
                                    <AccordionPanel pb={4}>
                                        ...
                                        >
                                            <UnorderedList>
                                                <ListItem>
                                                    {t(
                                                        'internship.Required Skills.list.0'
                                                    )}
                                                </ListItem>
                                                <ListItem>
                                                    {t(
                                                        'internship.Required Skills.list.1'
                                                    )}
                                                </ListItem>
                                                <ListItem>
                                                    {t(
                                                        'internship.Required Skills.list.2'
                                                    )}
                                                </ListItem>
                                                <ListItem>
                                                    {t(
                                                        'internship.Required Skills.list.3'
                                                    )}
                                                </ListItem>
                                            </UnorderedList>
                                        </Text>
                                ...
                                <AccordionItem>
                                    ...
                                    >
                                        <Text fontSize='md'>
                                            {t(
                                                'internship.Internship Details.title'
                                            )}{' '}
                                            📝
                                        </Text>
                                        <ChevronDownIcon fontSize='24px' />
                                    ...
                                    <AccordionPanel pb={4}>
                                        ...
                                        >
                                            <UnorderedList>
                                                <ListItem>
                                                    {t(
                                                        'internship.Internship Details.list.0'
                                                    )}
                                                </ListItem>
                                                <ListItem>
                                                    {t(
                                                        'internship.Internship Details.list.1'
                                                    )}
                                                </ListItem>
                                                <ListItem>
                                                    {t(
                                                        'internship.Internship Details.list.2'
                                                    )}
                                                </ListItem>
                                                <ListItem>
                                                    {t(
                                                        'internship.Internship Details.list.3'
                                                    )}
                                                </ListItem>
                                            </UnorderedList>
                                        </Text>
                            ...
                            >
                                    ...
                                    >
                                        <Box
                                            ...
                                            _after={{
                                                ...
                                                left: 0,
                                                backgroundImage:
                                                    '/assets/images/leadCapital.jpeg',
                                                filter: 'blur(15px)',
                                                zIndex: -1,
                                            }}
                                            _groupHover={{
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        <Stack pt={10} align={'center'}>
                                            <Link
                                                href='https://twitter.com/thebuilderdao?lang=en'
                                                isExternal
                                            >
                                                <Heading
                                                    fontSize={'2xl'}
                                    ...
                                    >
                                        <Box
                                            ...
                                            _after={{
                                                ...
                                                left: 0,
                                                backgroundImage:
                                                    '/assets/images/taiwanBuilderHouse.svg',
                                                filter: 'blur(15px)',
                                                zIndex: -1,
                                            }}
                                            _groupHover={{
                                        ...
                                        <Stack pt={10} align={'center'}>
                                            <Link
                                                href='https://www.taiwanbuilderhouse.com/'
                                                isExternal
                                            >
                                                <Heading
                                                    fontSize={'2xl'}
                                    ...
                                    >
                                        <Box
                                            ...
                                            _after={{
                                                ...
                                                left: 0,
                                                backgroundImage:
                                                    '/assets/images/tradingTrain.jpeg',
                                                filter: 'blur(15px)',
                                                zIndex: -1,
                                            }}
                                            _groupHover={{
                                        ...
                                        <Stack pt={10} align={'center'}>
                                            <Link
                                                href='https://twitter.com/trading_train'
                                                isExternal
                                            >
                                                <Heading
                                                    fontSize={'2xl'}
                                    ...
                                    >
                                        <Box
                                            ...
                                            _after={{
                                                ...
                                                left: 0,
                                                backgroundImage:
                                                    '/assets/images/aceExchange.jpeg',
                                                filter: 'blur(15px)',
                                                zIndex: -1,
                                            }}
                                            _groupHover={{
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        <Stack pt={10} align={'center'}>
                                            <Link
                                                href='https://linktr.ee/BCA_Daniel'
                                                isExternal
                                            >
                                                <Heading
                                                    fontSize={'2xl'}
