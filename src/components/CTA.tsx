                ...
                <Stack spacing={4}>
                    ...
                    >
                        <Feature
                            ...
                            text={t('internship.Internship Content.list.0')}
                        />
                        <Feature
                            icon={
                                <Icon
                            ...
                            text={t('internship.Internship Content.list.2')}
                        />
                        <Feature
                            icon={
                                <Icon
                            ...
                            text={t('internship.Internship Content.list.4')}
                        />
                    </Stack>
                </Stack>
                <Flex
                ...
                >
                    ...
                    >
                        ...
                        <Image
                            ...
                            w={'100%'}
                            h={'100%'}
                            src={'/assets/images/CA實習生文宣 (1).png'}
                        />
                    </Box>
                </Flex>
            </SimpleGrid>
                ...
                <Stack flex={1} spacing={{ base: 5, md: 10 }}>
                    ...
                    >
                        ...
                        <Text as={'span'} color={'purple.400'} fontWeight={800}>
                            {t('internship.Campus Quantitative Team Program')}
                        </Text>
                    </Heading>
                    <Text color={'gray.500'}>
                        {t('internship.Intro.forward')}
                ...
                >
                    ...
                    >
                        ...
                        <Image
                            ...
                            w={'100%'}
                            h={'100%'}
                            src={'/assets/images/ca_scene.jpg'}
                        />
                    </Box>
                </Flex>
            </Stack>
